  ...
  return (
    <>
      <div className={`container my-3 text-${props.mode === 'dark'?'light':'dark'}`}>
        ...
        <textarea className="form-control" id="exampleFormControlTextarea1" style={{backgroundColor: props.mode==='dark'?'white':'black', color: props.mode === 'dark'?'black':'white'}} rows="8" value={text} onChange={handleChange} placeholder="Enter your text"></textarea>
        <button className='btn btn-primary my-3 mx-1' onClick={convertToupper}>Convert to UPPERCASE</button>
        <button className='btn btn-primary my-3 mx-1' onClick={convertTolower}>Convert to lowercase</button>
